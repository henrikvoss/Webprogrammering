...
<body>
	...
	<section class="lookbook">
		<?php	printLookbook(17, 17, 'ss10-', '2010SS'); ?>

			<a href="2010SS1.php#style">
				<img id="style" src="Images/2010SS/Lookbook/17.jpg" alt="Jumpsuit"
		...
		<p class="floatRight">
			<a href="2010SS16.php#style">prev</a>
			|
			<a href="2010SS1.php#style">next</a>
		</p>
