...
<body>
	...
	<section class="lookbook">
		<?php	printLookbook(17, 16, 'ss10-', '2010SS'); ?>

			<a href="2010SS17.php#style">
				<img id="style" src="Images/2010SS/Lookbook/16.jpg" alt="Tights"
		...
		<p class="floatRight">
			<a href="2010SS15.php#style">prev</a>
			|
			<a href="2010SS17.php#style">next</a>
		</p>
