...
<body>
	...
	<section class="lookbook">
		<?php	printLookbook(17, 10, 'ss10-', '2010SS'); ?>

			<a href="2010SS11.php#style">
				<img id="style" src="Images/2010SS/Lookbook/10.jpg" alt="Dress"
		...
		<p class="floatRight">
			<a href="2010SS9.php#style">prev</a>
			|
			<a href="2010SS11.php#style">next</a>
		</p>
