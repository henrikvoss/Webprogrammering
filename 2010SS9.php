...
<body>
	...
	<section class="lookbook">
		<?php	printLookbook(17, 9, 'ss10-', '2010SS'); ?>

			<a href="2010SS10.php#style">
				<img id="style" src="Images/2010SS/Lookbook/9.jpg" alt="Dress"
		...
		<p class="floatRight">
			<a href="2010SS8.php#style">prev</a>
			|
			<a href="2010SS10.php#style">next</a>
		</p>
