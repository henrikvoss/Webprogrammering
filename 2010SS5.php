...
<body>
	...
	<section class="lookbook">
		<?php	printLookbook(17, 5, 'ss10-', '2010SS'); ?>

			<a href="2010SS6.php#style">
				<img id="style" src="Images/2010SS/Lookbook/5.jpg" alt="Dress"
		...
		<p class="floatRight">
			<a href="2010SS4.php#style">prev</a>
			|
			<a href="2010SS6.php#style">next</a>
		</p>
