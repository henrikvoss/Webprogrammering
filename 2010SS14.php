...
<body>
	...
	<section class="lookbook">
		<?php	printLookbook(17, 14, 'ss10-', '2010SS'); ?>

			<a href="2010SS15.php#style">
				<img id="style" src="Images/2010SS/Lookbook/14.jpg" alt="Dress"
		...
		<p class="floatRight">
			<a href="2010SS13.php#style">prev</a>
			|
			<a href="2010SS15.php#style">next</a>
		</p>
