...
<body>
	...
	<section class="lookbook">
		<?php	printLookbook(17, 12, 'ss10-', '2010SS'); ?>

			<a href="2010SS13.php#style">
				<img id="style" src="Images/2010SS/Lookbook/12.jpg" alt="Dress"
		...
		<p class="floatRight">
			<a href="2010SS11.php#style">prev</a>
			|
			<a href="2010SS13.php#style">next</a>
		</p>
