...
<body>
	...
	<section class="lookbook">
		<?php	printLookbook(17, 6, 'ss10-', '2010SS'); ?>

			<a href="2010SS7.php#style">
				<img id="style" src="Images/2010SS/Lookbook/6.jpg" alt="Dress"
		...
		<p class="floatRight">
			<a href="2010SS5.php#style">prev</a>
			|
			<a href="2010SS7.php#style">next</a>
		</p>
