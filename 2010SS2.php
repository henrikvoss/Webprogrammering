...
<body>
	...
	<section class="lookbook">
		<?php
			printLookbook(17, 2, 'ss10-', '2010SS');
		?>

			<a href="2010SS3.php#style">
				<img id="style" src="Images/2010SS/Lookbook/2.jpg" alt="Dress"
		...
		<p class="floatRight">
			<a href="2010SS1.php#style">prev</a>
			|
			<a href="2010SS3.php#style">next</a>
		</p>
