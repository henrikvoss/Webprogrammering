...
<body>
	...
	<section class="lookbook">
		<?php	printLookbook(17, 7, 'ss10-', '2010SS'); ?>

			<a href="2010SS8.php#style">
				<img id="style" src="Images/2010SS/Lookbook/7.jpg" alt="Dress"
		...
		<p class="floatRight">
			<a href="2010SS6.php#style">prev</a>
			|
			<a href="2010SS8.php#style">next</a>
		</p>
