...
<body>
	...
	<section class="lookbook">
		<?php	printLookbook(17, 3, 'ss10-', '2010SS'); ?>

			<a href="2010SS4.php#style">
				<img id="style" src="Images/2010SS/Lookbook/3.jpg" alt="Dress"
		...
		<p class="floatRight">
			<a href="2010SS2.php#style">prev</a>
			|
			<a href="2010SS4.php#style">next</a>
		</p>
