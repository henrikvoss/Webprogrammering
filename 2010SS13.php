...
<body>
	...
	<section class="lookbook">
		<?php	printLookbook(17, 13, 'ss10-', '2010SS'); ?>

			<a href="2010SS14.php#style">
				<img id="style" src="Images/2010SS/Lookbook/13.jpg" alt="Dress"
		...
		<p class="floatRight">
			<a href="2010SS12.php#style">prev</a>
			|
			<a href="2010SS14.php#style">next</a>
		</p>
